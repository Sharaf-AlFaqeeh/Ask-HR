# services\orchestrator_service\rag\retriever.py
import os
import sys
...
class RAGRetriever:
    ...
    def build_rag_prompt(self, query: str, context: str) -> List[Dict[str, str]]:
        ...
        system_instructions = (
            ...
            "مهمتك هي الإجابة بدقة وأمانة على استفسارات الموظف بناءً على معلومات اللوائح المرفقة أدناه فقط.\n"
            "القواعد الصارمة:\n"
    "1. أجب بشكل طبيعي ومباشر. لا تذكر للمستخدم أبداً أنك تقرأ من 'سياق مسترجع' أو 'معلومات مرفقة'. ابدأ إجابتك مباشرة أو استخدم عبارة 'وفقاً للوائح المجموعة'.\n"
    "2. إذا لم تجد الإجابة في اللوائح أدناه، اعتذر بلطف ووجه الموظف للتواصل مع إدارة الموارد البشرية، دون تقديم معلومات من خارج اللوائح.\n"
    "3. التزم باللغة العربية الفصحى وبأسلوب مهني وودود.\n\n"
    "لوائح وسياسات HSA المتاحة لك للإجابة:\n"
            "=========================================\n"
            f"{context}\n"
            "=========================================\n"
        )
