        ...
        if missing_prompt:
            ...
            if citations:
                ...
                system_instruction = (
                    ...
                    "لا تذكر أبداً في إجابتك أي عبارات تقنية مثل 'سياق مسترجع'، 'مسترجعة'، 'نظام RAG'، أو 'النصوص المرفقة'، بل ابدأ إجابتك مباشرة أو بعبارات مثل 'وفقاً لسياسات المجموعة...'.\n"
