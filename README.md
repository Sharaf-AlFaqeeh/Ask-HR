# AskHR Enterprise AI Orchestration Engine (نظام أوركسترا الموارد البشرية)

مرحباً بك في المحرك الأساسي لـ **AskHR**، منصة الذكاء الاصطناعي المؤسسية لإدارة وتنسيق خدمات الموارد البشرية بمجموعة هائل سعيد أنعم (HSA Group). 
